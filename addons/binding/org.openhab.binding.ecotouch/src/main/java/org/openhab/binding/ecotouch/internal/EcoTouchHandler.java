...
public class EcoTouchHandler extends BaseThingHandler {
    ...
    @Nullable
    private EcoTouchConfiguration config;
    ...
    public void handleCommand(ChannelUID channelUID, Command command) {
        if (CHANNEL_temperature_outside.equals(channelUID.getId())) {
        ...
        } else if (CHANNEL_temperature_outside_1h.equals(channelUID.getId())) {
            if (command instanceof RefreshType) {
                // TODO: handle data refresh
            }
            ...
            // updateStatus(ThingStatus.OFFLINE, ThingStatusDetail.COMMUNICATION_ERROR,
            // "Could not control device at IP address x.x.x.x");
        } else if (CHANNEL_temperature_outside_24h.equals(channelUID.getId())) {
            if (command instanceof RefreshType) {
                // TODO: handle data refresh
            }
